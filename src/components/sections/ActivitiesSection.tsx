...
function ActivityCard({ title, description, emoji, tags, gradientFrom, gradientTo, hoverColor, iconShape }: ActivityCardProps) {
  ...
  return (
    <div className="group relative h-80">
      <div className={`relative bg-white/90 backdrop-blur-lg rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform -translate-y-2 hover:-translate-y-4 border-2 border-gray-100/60 hover:border-${hoverColor}/30 h-full`}>
